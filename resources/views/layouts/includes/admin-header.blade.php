        ...
        <div class="navbar-container content">
            <div class="collapse navbar-collapse" id="navbar-mobile">
                ...
                <span class="mr-1">مرجبا
                  <span
                      class="user-name text-bold-700">{{\Illuminate\Support\Facades\Auth::guard('admin')->user()->name}}</span>
                </span>
                            <span class="avatar avatar-online">
                  <img  style="height: 35px;" src="https://png.pngtree.com/png-vector/20190917/ourmid/pngtree-circle-logout-icon-vectors-png-image_1737864.jpg" alt="avatar"><i></i></span>
                        </a>
