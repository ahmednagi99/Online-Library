        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title"> الكتب </h3>
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">الرئيسية</a>
                                </li>
                                <li class="breadcrumb-item active"> الكتب
                                </li>
                            </ol>
                        </div>
                    </div>
                                            ...
                                            <tr>
                                               ...
                                               <td>
                                                ...
                                                <div class="btn-group" role="group"
                                                                ...
                                                                <a href=""   data-toggle="modal" data-target="#exampleModal" data-id="{{$book->id}}" data-name="{{$book->name}}"
                                                                   class="btn btn-outline-danger btn-min-width box-shadow-3 mr-1 mb-1 delete_book">حذف</a>
